    ...
    <div class="jumbotron">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                <asp:Label ID="ItemName" runat="server" Text="Name" AssociatedControlID="ItemNameInput" class="col-lg-2 control-label" />
                <div class="col-lg-10">
            ...
            <div class="form-group">
                <asp:Label ID="ItemDescription" runat="server" Text="Description" AssociatedControlID="ItemDescriptionInput" class="col-lg-2 control-label" />
                <div class="col-lg-10">
